  ...
  return (
    <section className="px-6 md:px-10 lg:px-16 py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-10">
        {/* Card 1 */}
        <div
          className="md:col-span-2  min-h-82 rounded-3xl p-7 flex flex-col justify-between bg-cover bg-position-[100%_center]"
        ...
        <div className="min-h-82 bg-[#292640] rounded-3xl text-white flex flex-col justify-between ">
          <h3 className="text-2xl font-medium max-w-68 p-4">
            Always liquid, always stable
          </h3>
          <p className="text-gray-300 max-w-xs text-sm p-5">
        ...
        {/* Card3 */}
        <div className="min-h-82 bg-[#292640] rounded-3xl text-white flex flex-col justify-between">
          <h3 className="text-2xl font-medium max-w-40 p-4">100% hands-free</h3>
          <p className="text-gray-300 max-w-xs text-sm p-5">
